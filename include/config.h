...
const int ROLLER_A_POS_X = 171;
const int ROLLER_A_POS_Y = 285;
const int ROLLER_B_POS_X = 410;
const int ROLLER_B_POS_Y = 285;
const int ROLLER_C_POS_X = 650;
const int ROLLER_C_POS_Y = 285;
const int ROLLER_D_POS_X = 885;
const int ROLLER_D_POS_Y = 285;
const int ROLLER_E_POS_X = 1125;
const int ROLLER_E_POS_Y = 285;

const int START_BUTTON_POS_X = 410;
const int START_BUTTON_POS_Y = 575;
const int STOP_BUTTON_POS_X = 760;
const int STOP_BUTTON_POS_Y = 575;

const int SCOREBOARD_POS_X = 50;
const int SCOREBOARD_POS_Y = 260;

const int WINNER_LOGO_POS_X = 445;
